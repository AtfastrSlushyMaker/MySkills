...
function DashboardPage() {
    ...
    if (loading) {
        return (
            <div className="min-h-screen flex items-center justify-center relative">
                ...
                <div className="bg-white/10 backdrop-blur-3xl rounded-3xl p-8 border border-white/20 z-10">
    ...
    if (!user) {
        return (
            <div className="min-h-screen flex items-center justify-center relative">
                <GlassmorphismBackground />
                <div className="bg-white/10 backdrop-blur-3xl rounded-3xl p-8 border border-white/20 text-center z-10">
